package ig.getarrays.server;


import ig.getarrays.server.enumeration.Status;
import ig.getarrays.server.model.Server;
import ig.getarrays.server.repo.ServerRepo;
...
import static ig.getarrays.server.enumeration.Status.SERVER_UP;
...
//
		...
		corsConfiguration.setExposedHeaders(
				Arrays.asList("Origin", "Content-Type", "Accept", "Jwt-Token",
				"Authorization", "Access0Control-Allow-Origin", "Access-Control-Allow-Origin",
